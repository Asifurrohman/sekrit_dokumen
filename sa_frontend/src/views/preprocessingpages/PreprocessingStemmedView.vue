<template>
    <div class="flex justify-between items-end mb-4">
        <h2 class="text-slate-700 font-semibold text-2xl">Detail Tahap Stemming</h2>
...
{ label: 'Pra-pemrosesan (Stemming)', key: 'stemmedTweet', sortable: true },
...
const fetchProcessedDataset = async (page = 1) => {
    ...
    try {
        ...
        processedTweets.value = data.data.map((item, index) => ({
            ...
            stemmedTweet: item.stemmedTweet,
