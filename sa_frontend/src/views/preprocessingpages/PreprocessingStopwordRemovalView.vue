<template>
    <div class="flex justify-between items-end mb-4">
        <h2 class="text-slate-700 font-semibold text-2xl">Detail Tahap Stopword Removal</h2>
...
{ label: 'Pra-pemrosesan (Stopword Removal)', key: 'stopwordremovedTweet', sortable: true },
...
const fetchProcessedDataset = async (page = 1) => {
    ...
    try {
        ...
        processedTweets.value = data.data.map((item, index) => ({
            ...
            stopwordremovedTweet: item.stopwordremovedTweet,
