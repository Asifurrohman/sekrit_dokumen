<template>
    <div class="flex justify-between items-end mb-4">
        <h2 class="text-slate-700 font-semibold text-2xl">Detail Tahap Pembersihan Data</h2>
...
{ label: 'Pra-pemrosesan (Cleaning)', key: 'cleansedTweet', sortable: true },
...
const fetchProcessedDataset = async (page = 1) => {
    ...
    try {
        ...
        processedTweets.value = data.data.map((item, index) => ({
            ...
            cleansedTweet: item.cleansedTweet,
