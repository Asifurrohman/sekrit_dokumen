<template>
    <div class="flex justify-between items-end mb-4">
        <h2 class="text-slate-700 font-semibold text-2xl">Detail Tahap Perbaikan Kata</h2>
...
{ label: 'Pra-pemrosesan (Perbaikan Kata)', key: 'fixedwordsTweet', sortable: true },
...
const fetchProcessedDataset = async (page = 1) => {
    ...
    try {
        ...
        processedTweets.value = data.data.map((item, index) => ({
            ...
            fixedwordsTweet: item.fixedwordsTweet,
